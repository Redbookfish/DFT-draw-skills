#!/usr/bin/env python3
"""
Check and fix Gaussian .gjf input files for ESP calculation.
...
def main():
    parser = argparse.ArgumentParser(
        description="Check and fix Gaussian .gjf for ESP calculation"
    )
